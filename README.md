...
Para isso vamos incluir no formulário de cadastro de séries a rota de cadastro da rota através do atributo action"/serie/salvar" e method="post", o resultado do formulário será o seguinte:
